      ...
      <Layout>
        <Center>
          <Card bg="AntiqueWhite" border="3px black solid" width={["75%"]}borderRadius={15}>
            ...
            <h5 className="card-text px-2 py-2">Location : {y.place_name}</h5>
          <p className="card-text px-2 ">Street Name : {y.street_name}</p>
          <p className="card-text px-2"> Town : {y.town}</p>
          <p className="card-text px-2 ">State : {y.state}</p>
          <p className="card-text px-2 py-2">Zip Code : {y.zip_code} </p>
            </CardBody>
          </Card>
        </Center>
      </Layout>
